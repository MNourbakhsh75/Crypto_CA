...
my_private_key = bitcoin.wallet.CBitcoinSecret("93NGdZLXsdUzHa7MSvRQkENCf4nJGNpMwM1tcTd3XFVdtdSbSs8") # Private key in WIF format XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
def send_from_P2PKH_transaction(amount_to_send, txid_to_spend, utxo_index,
    ...
    txin_scriptPubKey = P2MS_scriptPubKey(public_key_1,public_key_2,public_key_3)
...
def P2MS_scriptSig(txin, txout, txin_scriptPubKey):
    ...
    signature_1 = create_OP_CHECKSIG_signature(txin, txout, txin_scriptPubKey, private_key_1)
    signature_2 = create_OP_CHECKSIG_signature(txin, txout, txin_scriptPubKey, private_key_2)

    return [OP_0,signature_1 , signature_2] 

if __name__ == '__main__':
    ######################################################################
    amount_to_send = 0.01
    txid_to_spend = ('756a5764d273f599b9e641a1589db416fef66f79f1ce53d1492b15d8903a4be4') # TxHash of UTXO
